...
type Setting struct {
	...
	FieldValues pulumi.StringMapArrayOutput `pulumi:"fieldValues"`
	// Setting key
...
type settingState struct {
	// Setting field values for the supplied key
	FieldValues []map[string]string `pulumi:"fieldValues"`
	// Setting key
...
type SettingState struct {
	// Setting field values for the supplied key
	FieldValues pulumi.StringMapArrayInput
	// Setting key
...
// Setting field values for the supplied key
func (o SettingOutput) FieldValues() pulumi.StringMapArrayOutput {
	return o.ApplyT(func(v *Setting) pulumi.StringMapArrayOutput { return v.FieldValues }).(pulumi.StringMapArrayOutput)
}
