...
type ProjectSettingArgs struct {
	// Setting field values for the supplied key
	FieldValues pulumi.StringMapArrayInput `pulumi:"fieldValues"`
	// Setting key
...
// Setting field values for the supplied key
func (o ProjectSettingOutput) FieldValues() pulumi.StringMapArrayOutput {
	return o.ApplyT(func(v ProjectSetting) []map[string]string { return v.FieldValues }).(pulumi.StringMapArrayOutput)
}
