...
namespace Pulumi.Sonarqube
{
    ...
    public partial class Setting : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("fieldValues")]
        public Output<ImmutableArray<ImmutableDictionary<string, string>>> FieldValues { get; private set; } = null!;
    ...
    {
        [Input("fieldValues")]
        private InputList<ImmutableDictionary<string, string>>? _fieldValues;

        /// <summary>
        /// Setting field values for the supplied key
        /// </summary>
        public InputList<ImmutableDictionary<string, string>> FieldValues
        {
            get => _fieldValues ?? (_fieldValues = new InputList<ImmutableDictionary<string, string>>());
